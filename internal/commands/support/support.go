...
func Usage(w io.Writer) {
	...
	fmt.Fprintln(w, "  konfirm kubecolor <kubectl args...>")
	fmt.Fprintln(w, "  konfirm <command> [args...]")
	fmt.Fprintln(w, "")
	fmt.Fprintln(w, "Commands:")
	fmt.Fprintln(w, "  kubectl      Run kubectl after confirming the effective context")
	fmt.Fprintln(w, "  kubecolor    Run kubecolor after confirming the effective context")
	...
	fmt.Fprintln(w, "  konfirm kubecolor get pods")
